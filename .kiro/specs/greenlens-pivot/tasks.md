...
- [x] 1. Backend foundation: models, config, quick-scan prompt
  - [x] 1.1 Add additive fields to response models
  ...
  - [x] 1.2 Add vision model configuration
  ...
  - [x] 1.3 Create quick-scan prompt module
...
- [x] 2. Backend: rewrite the 5 core analysis prompts for the greenwashing domain
  - [x] 2.1 Rewrite system_prompt.py
  ...
  - [x] 2.2 Rewrite conflict_detection.py
  ...
  - [x] 2.3 Rewrite risk_analysis.py
  ...
  - [x] 2.4 Rewrite executive_summary.py and add greenwashScore parsing
  ...
  - [x] 2.5 Rewrite recommendation.py
  ...
  - [x] 2.6 Update comparison matrix prompt in analysis_service.py
  ...
  - [x] 2.7 Rewrite chat_copilot.py and add ELI15 branch
  ...
  - [x] 2.8 Wire simplify flag through chat router
...
- [x] 3. Checkpoint — Verify backend prompt rewrites compile and existing tests pass
...
- [x] 4. Backend: new endpoints — Quick Scan and Snap & Check
  - [x] 4.1 Implement quick-scan router
  ...
  - [x] 4.2 Implement vision completion method in LLMService
  ...
  - [x] 4.3 Implement vision chat route
...
- [x] 5. Backend: demo documents replacement
  - [x] 5.1 Create new demo sample documents
  ...
  - [x] 5.2 Update demo router to use new documents
...
- [x] 6. Checkpoint — Verify new backend endpoints and demo data
...
- [x] 7. Frontend: types, API functions, design tokens
  - [x] 7.1 Add additive frontend types
  ...
  - [x] 7.3 Apply GreenLens design tokens
...
- [x] 8. Frontend: new shared components
  - [x] 8.1 Create GreenwashScoreGauge component
  ...
  - [x] 8.2 Create ClaimVsRealityRow component
  ...
  - [x] 8.3 Update Badges.tsx label/color mapping
  ...
  - [x] 8.4 Update ConflictAlert → ContradictionAlert styling
  ...
  - [x] 8.5 Create QuickScanPanel component
...
- [x] 9. Checkpoint — Verify new components compile
  - Run `tsc --noEmit` in `frontend/`. Ask the user if errors arise.

- [x] 10. Frontend: page rebrand — Landing, Dashboard, Chat, Demo
  - [x] 10.1 Rebrand Landing.tsx
  ...
  - [x] 10.5 Rebrand NavigationBar wordmark
...
- [x] 11. Checkpoint — Verify all pages compile and render
  - Run `tsc --noEmit` and `npm run build` in `frontend/`. Ask the user if errors arise.

- [x] 12. Verification and cleanup
  - [x] 12.1 Verify additive-only backend model changes
  ...
  - [x] 12.2 Verify additive-only frontend type changes
  ...
  - [x] 12.3 Verify API function signature preservation
  ...
  - [x] 12.4 Verify AMD signal color isolation
  ...
  - [x]* 12.5 Write backend property tests
...
- [x] 13. Final checkpoint — Ensure all tests pass and demo works end-to-end
